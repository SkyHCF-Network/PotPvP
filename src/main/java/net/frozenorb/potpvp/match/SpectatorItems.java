...
public final class SpectatorItems {
    ...
    static {
        ItemUtils.setDisplayName(SHOW_SPECTATORS_ITEM, ChatColor.AQUA + "Show spectators");
        ItemUtils.setDisplayName(HIDE_SPECTATORS_ITEM, ChatColor.AQUA + "Hide spectators");

        ItemUtils.setDisplayName(VIEW_INVENTORY_ITEM, ChatColor.AQUA + "View player inventory");

        ItemUtils.setDisplayName(RETURN_TO_LOBBY_ITEM, ChatColor.AQUA + "Return to lobby");
        ItemUtils.setDisplayName(LEAVE_PARTY_ITEM, ChatColor.AQUA + "Leave party");
    }
