...
public final class QueueItems {
    ...
    static {
        ...
        ItemUtils.setDisplayName(JOIN_SOLO_RANKED_QUEUE_ITEM, DARK_AQUA + "Play Ranked");
        ItemUtils.setDisplayName(LEAVE_SOLO_RANKED_QUEUE_ITEM, RED + "Leave Ranked Queue");

        ItemUtils.setDisplayName(JOIN_PARTY_UNRANKED_QUEUE_ITEM, LIGHT_PURPLE + "Play 2v2 Unranked");
        ItemUtils.setDisplayName(LEAVE_PARTY_UNRANKED_QUEUE_ITEM, RED + "Leave 2v2 Unranked Queue");

        ItemUtils.setDisplayName(JOIN_PARTY_RANKED_QUEUE_ITEM, DARK_PURPLE + "Join 2v2 Ranked");
